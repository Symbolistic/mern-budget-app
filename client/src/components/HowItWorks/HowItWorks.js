  ...
  return (
    <div id="container">
      ...
      <img
        ...
        alt="showing how to generate a template"
        height="100%"
        width="80%"
      />
      ...
      <img
        src={addinggroups}
        alt="showing how to add incomes"
        height="100%"
        width="80%"
      />
      ...
      <img
        src={addingentries}
        alt="showing how to add entries to your income or expenses"
        height="100%"
        width="80%"
      />
      ...
      <img
        src={budgetactual}
        alt="showing how to switch between budget data and actual spent data"
        height="100%"
        width="80%"
      />
    </div>
